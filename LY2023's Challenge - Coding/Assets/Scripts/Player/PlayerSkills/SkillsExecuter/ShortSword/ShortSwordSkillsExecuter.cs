...
public class ShortSwordSkillsExecuter : WeaponSkillsExecuter
{
    ...
    protected override void Start() 
    {
        ...
        GameObject swordRanges = GameObject.Find("Player/Character/MeleeWeaponsAttackRanges/Sword");
        ...
        GameObject shortSwordEffects = GameObject.Find("Player/Effects/ShortSword");
    ...
    private void OnCollisionEnter2D(Collision2D collision) 
    {
        ...
        {
            collision.gameObject.GetComponent<AttributesManager>().TakeDamage(this._eDamage);   
        } 
    }
}