    ...
    public class ArrowController : MonoBehaviour
    {
        ...
        private void OnTriggerEnter2D(Collider2D collider)
        {
            if ((collider.tag == "Enemy") && (_boxCollider2D.isTrigger))
            {
                ...
                collider.GetComponent<AttributesManager>().TakeDamage(PlayerManager.Instance.Player.GetComponent<AttributesManager>(), _physicalDamage, _physicalPierce, false);
            }
        }
        ...
        private void OnCollisionEnter2D(Collision2D collision)
        {
            if (collision.gameObject.tag != "Player")
            {
                ...
                {
                    collision.gameObject.GetComponent<AttributesManager>().TakeDamage(PlayerManager.Instance.Player.GetComponent<AttributesManager>(), _physicalDamage, _physicalPierce, false);
                }
