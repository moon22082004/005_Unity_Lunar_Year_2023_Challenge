    ...
    public class FiveArrows : BowSkill
    {
        ...
        public override IEnumerator Execute(SkillsManager skillsManager, int skillIndex)
        {
            if (this.Arrows.Count > 4)
            {
                ...
                this.Arrows[this.InactiveArrowIndex].GetComponent<ArrowController>().SetUpCommonArrow(this.ProjectilesPositions[index], mousePos, 20, this.ProjectileLifeTime, this.ProjectileSpeed, ArrowType.NormalArrow, this.AttributesManager.PhysicalDamage * 0.6f, this.AttributesManager.PhysicalPierce);
                this.Arrows[this.InactiveArrowIndex].GetComponent<ArrowController>().SetUpCommonArrow(this.ProjectilesPositions[index], mousePos, 10, this.ProjectileLifeTime, this.ProjectileSpeed, ArrowType.NormalArrow, this.AttributesManager.PhysicalDamage * 0.6f, this.AttributesManager.PhysicalPierce);
                this.Arrows[this.InactiveArrowIndex].GetComponent<ArrowController>().SetUpCommonArrow(this.ProjectilesPositions[index], mousePos, 0, this.ProjectileLifeTime, this.ProjectileSpeed, ArrowType.NormalArrow, this.AttributesManager.PhysicalDamage * 0.6f, this.AttributesManager.PhysicalPierce);
                this.Arrows[this.InactiveArrowIndex].GetComponent<ArrowController>().SetUpCommonArrow(this.ProjectilesPositions[index], mousePos, -10, this.ProjectileLifeTime, this.ProjectileSpeed, ArrowType.NormalArrow, this.AttributesManager.PhysicalDamage * 0.6f, this.AttributesManager.PhysicalPierce);
                this.Arrows[this.InactiveArrowIndex].GetComponent<ArrowController>().SetUpCommonArrow(this.ProjectilesPositions[index], mousePos, -20, this.ProjectileLifeTime, this.ProjectileSpeed, ArrowType.NormalArrow, this.AttributesManager.PhysicalDamage * 0.6f, this.AttributesManager.PhysicalPierce);
